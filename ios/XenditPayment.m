...
RCT_EXTERN_METHOD(createAuthentication:(NSString *)tokenId amount:(nonnull NSNumber *)amount onBehalfOf:(NSString *)onBehalfOf withResolver:(RCTPromiseResolveBlock)resolve withRejecter:(RCTPromiseRejectBlock)reject)
